...
To determine the best seat for a view, I classified each approach based on the mean latitude. If the mean latitude of an approach is smaller than that of the airport, the approach is from the northeast. If it's higher, the approach is from the southeast.
...
Now, all I need to do is classify each approach to easily tally them up.
...
To conclude this blog post, I'll examine the duration of the flight. It's scheduled to last 12 hours and 5 minutes, or 720 minutes. Lets see the distribution across all flights in a box plot.
...
Let's proceed with this method and aim to answer the question: 
Are flights with a holding pattern more susceptible to a longer flight duration?
...
This was again fun to analyze. Hope you enjoyed it!
I will definitely sit on the left side of the plane (thumbs pressed for clear view) and not worry to much about holding patterns since they are pretty usual on this fligth.
