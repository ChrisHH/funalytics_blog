...
Similarly, the coupon providing '5,000 extra points for purchases over €20' (green line) benefits customers only within a very narrow spending range.

Another observation is that coupons offering a relative increase in extra loyalty points perform better, because as one can see in the graph, as the purchase value increases, the gap between standard and extra points widens.
