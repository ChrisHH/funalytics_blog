...
The coupons providing 'Triple points for a purchase of 15 Euros or more' (blue line) and '5,000 extra points for purchases over €20' (green line) benefits customers only within a very narrow spending range of €5. Let's take a brief look at the intersection around €25, where both lines intersect. Is it irrelevant which coupon one uses there? Not at all :-) The zoom shows that. Also, just before the next threshold, the coupon '5,000 extra points for purchases over €20' is preferable.
